...
export default async function DentistCatalog({dentistsJson} : {dentistsJson: DentistJson}) {

    const dentistsJsonReady = dentistsJson

    return (
            <div className="bg-black rounded-lg pt-10 m-5 flex flex-wrap justify-center" 
